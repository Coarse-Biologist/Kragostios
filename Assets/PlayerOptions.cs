...
public class PlayerOptions : MonoBehaviour
{
    ...
    public void DisplayLoadAndSaveButtons(StatsHandler stats, Map map, TravelScript travelScript)
    {
        ...
        saveButton.RegisterCallback<ClickEvent>(e => SaveSystem.SaveAll(stats, map, travelScript));
